...
SOURCES_C += drivers/base/core.c drivers/base/virtual.c drivers/base/uevent.c drivers/base/bus.c drivers/base/class.c drivers/base/driver.c drivers/base/platform.c drivers/base/init.c drivers/pci/pci.c drivers/pci/pcie/pcie.c drivers/nvme/nvme-core.c drivers/nvme/nvme.c drivers/input/serio/serio.c drivers/input/serio/i8042.c drivers/input/keyboard/atkbd.c drivers/block/ramdisk.c
SOURCES_C += drivers/clocksource/timer.c drivers/tty/tty.c drivers/tty/n_tty.c drivers/tty/serial/serial.c
