...
SOURCES_C = kernel/kernel.c kernel/syscall.c kernel/task.c kernel/shell.c \
	...
	fs/vfs.c fs/file.c fs/inode.c fs/dentry.c fs/namei.c fs/read_write.c fs/open.c fs/readdir.c fs/ioctl.c fs/ramfs/ramfs.c fs/initrd/initrd.c fs/procfs/procfs.c fs/devfs/devfs.c fs/sysfs/sysfs.c \
