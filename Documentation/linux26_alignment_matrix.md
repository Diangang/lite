...
| drivers/nvme/nvme.c | drivers/block/nvme*（2.6 时代 NVMe 不存在） | Diverged | NVMe 不属于 Linux 2.6，但在 Lite 目标中需要；参考后续 Linux 的 NVMe 实现风格，保持 drivers/ 体系与 block/filesystem 语义可对接 |
